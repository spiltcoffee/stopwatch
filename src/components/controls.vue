<template>
  <div class="flex">
    <div
      ...
      @click="playable && $emit('play')"
    >
      <i class="fas fa-play opacity-75" />
    </div>
    <div
      v-else
      class="m-2 w-6 h-6 rounded bg-blue-700 hover:bg-blue-600 active:bg-blue-500 text-white text-center shadow-md hover:shadow-lg transition"
      @click="$emit('pause')"
    >
