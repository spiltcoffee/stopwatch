  ...
  >
    <div class="drag-none flex flex-col">
      ...
      <label class="flex flex-col py-1">
        ...
        <input class="rounded border p-1" type="text" size="0" v-model.number="max" />
      </label>
      <button class="p-1 bg-white text-left" @click="alwaysOnTop = !alwaysOnTop">
        <i :class="alwaysOnTop ? 'far fa-square' : 'fa fa-check-square text-blue-600'" />
        Always On Top
      </button>
      <button class="p-1 bg-white text-left" @click="openAtLogin = !openAtLogin">
        <i :class="openAtLogin ? 'far fa-square' : 'fa fa-check-square text-blue-600'" />
        <span class="flex-1">Open At Login</span>
      </button>
      <button class="p-1 bg-white text-left" @click="autoKnock = !autoKnock">
        <i :class="autoKnock ? 'far fa-square' : 'fa fa-check-square text-blue-600'" />
        Auto Knock
      </button>
      <div class="flex">
        <button
