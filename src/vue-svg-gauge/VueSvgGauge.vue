  ...
  <div class="gauge">
    ...
    >
      <defs>
        ...
        <linearGradient v-if="hasGradient" :id="`gaugeGradient-${id}`">
          <stop
      ...
      <g :mask="`url(#innerCircle-${id})`">
        ...
        <circle
          ...
          :cx="X_CENTER"
          :cy="Y_CENTER"
          :fill="hasGradient ? `url(#gaugeGradient-${id})` : gaugeColor"
        />
        <path
          v-else
          :d="basePath"
